...
take the form of $p$-vectors of mixed continuous and categorical
...
The \Rclass{exprSet} class manages information of the type
...
containing an $N \times p$ data frame, a list of \texttt{varLabels}
...
matrices with potential performance efficiencies and fewer structural
restrictions than exist with an \Rclass{exprSet} instance.
