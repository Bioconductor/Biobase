...
%\VignetteDepends{Biobase, genefilter, class, annotate}
...
\item[description] A character description of the experiment.
...
<<HTML>>=
 ...
 llnames <- multiget(dimnames(outvals)[[1]], env=hgu95ll)
