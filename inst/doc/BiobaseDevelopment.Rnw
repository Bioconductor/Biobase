...
\eSet{} class hierarchy. This document outlines recent changes, and
illustrates how developers can exploit the new structure to
efficiently use and extend \eSet{}.
